...
public class RedisConfig implements CachingConfigurer {
    ...
    public CacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        cacheConfigurations.put("learnerDetails", defaultConfig.entryTtl(Duration.ofMinutes(15)));
        cacheConfigurations.put("trainerDetails", defaultConfig.entryTtl(Duration.ofMinutes(15)));
        cacheConfigurations.put("allTrainers", defaultConfig.entryTtl(Duration.ofMinutes(15)));
        cacheConfigurations.put("allPendingTrainers", defaultConfig.entryTtl(Duration.ofMinutes(15)));
